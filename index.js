...
let LutronDmxLight, LutronWindowCovering, CoolAdapter, NeoAdapter;
...
module.exports = function (homebridge) {
  ...
  const { CoolAdapter } = require('./cool-adapter.js')(homebridge);
  const { NeoAdapter } = require('./neo-adapter.js')(homebridge);
